...
SECRET_KEY = os.environ.get("SECRET_KEY", "pearl-secret-key")
...
REDIS_PORT = os.environ.get("REDIS_SERVICE_POST", 56379)
BROKER_PORT = 1
RESULTS_PORT = 2
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:8082', # replace with your frontend domain
]
